...
const IternaryList = ({ leads, setLeads }) => {
  ...
  useEffect(() => {
    const fetchHotels = async () => {
      try {
        const res = await axios.get("http://localhost:5000/hotels"); // 🔁 update this URL based on your API
  ...
  useEffect(() => {
    const fetchDestinations = async () => {
      try {
        const res = await axios.get("http://localhost:5000/destinations"); // 🔁 update this URL based on your API
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        "http://localhost:5000/Iternary/add",
        finalData
      );
