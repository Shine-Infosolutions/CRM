...
const InvoiceNewForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (id) {
        ...
        await axios.put(`http://localhost:5000/invoices/update/${id}`, payload);
        toast.success("Invoice updated successfully!");
      } else {
        // Create a new invoice
        await axios.post("http://localhost:5000/invoices/create", payload);
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/billing/all/wp")
      .then((res) => {
